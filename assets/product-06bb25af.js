...
．酒精成分：68%
．商品尺寸：10.2*5.8 cm
．使用方法：距離20-30釐米，在手部噴2-3次，再輕輕擦乾。`,price:199,evaluation:4.9,brand:"Rainbow",stock:300,sold:67,size:"無香味,玫瑰,葡萄柚,薰衣草,午後時光白色,糖果甜心粉色,白麝香藍色,木質調橘色,甜花香紅色",created_at:"2021-07-23 02:57:35",updated_at:"2021-07-23 02:57:35"},{id:5,trader:"xavier",img:"https://cf.shopee.tw/file/36a533db3081eada7d13c8aa55205055",category:"food",name:"每日優果 酸V脆脆桃 口袋蜜餞",text:`✔美味黃桃切丁製成，大小剛剛好
✔迷人酸V，忍不住一口接一口~
✔解饞好滋味~出遊、開會必備！
✔蜜餞類新品上市！
...
5.鈉(Sodium) 160毫克 
產地：中國 
⚠本產品含有亞硫酸鈉，不適合其過敏體質者食用⚠`,price:138,evaluation:4.2,brand:"每日優果",stock:700,sold:420,size:"一入,五入,十入",created_at:"2021-07-24 09:51:30",updated_at:"2021-07-24 09:51:30"}]}),actions:{set_product(t){this.currentProduct=t},edit_product(t){const i=e.findIndex(this.allProduct,["id",t.id]);this.allProduct[i]=t},del_product(t){const i=e.findIndex(this.allProduct,["id",t.id]);this.allProduct.splice(i,1)},set_shoppingCart(t){let i={id:t.id,name:t.name,img:t.img,size:[{size:t.size,count:t.count}]};if(this.shoppingCart.length>0){let o=e.findIndex(this.shoppingCart,["name",t.name]);if(o!=-1){let m=e.findIndex(this.shoppingCart[o].size,["size",t.size]);m!=-1?this.shoppingCart[o].size[m].count+=t.count:this.shoppingCart[o].size.push(i.size[0])}else this.shoppingCart.push(i)}else this.shoppingCart.push(i);this.shopping=e.compact(this.shopping)},del_shoppingCart(t,i){this.shoppingCart[t].size.length>1?this.shoppingCart[t].size.splice(i,1):this.shoppingCart.splice(t,1)}}});export{h as u};
